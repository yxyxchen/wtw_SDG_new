...
save(groupData, file = 'genData/expDataAnalysis/groupData.RData')
...
ggsave("figure/expDataAnalysis/earningExp.pdf", width = 8, height = 4)
...
ggsave("figure/expDataAnalysis/auc_distribution.pdf", width = 8, height = 4)
